...
router.post("/", authenticate, upload.array("images", 10), validate(createAnnouncementSchema), create);
...
router.post("/:id/images", authenticate, parseIdParam, isOwner, upload.array("images", 10), uploadImages);
router.delete("/:id/images/:imageId", authenticate, parseIdParam, isOwner, deleteImage);
